...
const { mapPrescriptionToFrappe, pickExternalId } = require("../normalize");
...
router.post("/", async (req, res) => {
  try {
    ...
    const doc = mapPrescriptionToFrappe({ ...body, external_id }, req.userLinkName);
    const saved = await erpCreate(DOCTYPE.MOBILE_APP_PRESCRIPTION, doc);
