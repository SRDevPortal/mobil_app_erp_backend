...
const { mapDiseaseSelectionToFrappe, pickExternalId } = require("../normalize");
...
router.post("/", async (req, res) => {
  try {
    ...
    const doc = mapDiseaseSelectionToFrappe({ ...body, external_id }, req.userLinkName);
    const saved = await erpCreate(DOCTYPE.MOBILE_APP_USER_DISEASE_SELECTION, doc);
