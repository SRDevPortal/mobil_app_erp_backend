...
const REMINDER_POLL_INTERVAL_MS = Number(process.env.REMINDER_POLL_INTERVAL_MS || 60 * 1000);
const REMINDER_SCHEDULER_DISABLED = trim(process.env.REMINDER_SCHEDULER_DISABLED || "").toLowerCase() === "true";
...
const RAZORPAY_CURRENCY = trim(process.env.RAZORPAY_CURRENCY || "INR").toUpperCase();
const APPOINTMENT_FEE_ONLINE_PAISE = Number(process.env.APPOINTMENT_FEE_ONLINE_PAISE || 9900);
const APPOINTMENT_FEE_OPD_PAISE = Number(process.env.APPOINTMENT_FEE_OPD_PAISE || 49900);
const APPOINTMENT_OPD_PAYABLE_AT_CLINIC_PAISE = Number(
  process.env.APPOINTMENT_OPD_PAYABLE_AT_CLINIC_PAISE || 50000,
);
